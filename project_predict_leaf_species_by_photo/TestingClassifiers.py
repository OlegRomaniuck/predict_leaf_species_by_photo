...
from DIPLOMA.my_dipl.kursovaya.DataPreProcessing import obtainXY,plot_confusion_matrix
from DIPLOMA.my_dipl.kursovaya.Classifiers import dumpClassifiers
...
def SVM(class_names, x_train, x_test, y_train, y_test):
    print('--------------------------------------------------SVM----------------------------------------------------')
    C_parm = [0.001,  0.01, 0.03, 0.1,  1,  10, 30 ]
    G_parm = [0.001,  0.01, 0.03, 0.1,  1,  10, 30]
    C_sel = 10
    G_sel = 0.3
    Acc_sel = 0
